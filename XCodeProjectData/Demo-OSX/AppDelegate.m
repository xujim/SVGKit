...
//  Demo-OSX
//
//  Created by C.W. Betts on 11/15/13.
...
- (void)tableViewSelectionDidChange:(NSNotification *)notification
{
	...
	if (selRow > -1 && selRow < [self.svgArray count]) {
		...
		if ([tmpObj isKindOfClass:[SKSVGBundleObject class]]) {
			...
			theImage = [[SVGKImage imageWithContentsOfFile:[[tmpObj svgURL] path]] retain];
			//[[SVGKImage alloc] initWithContentsOfURL:[tmpObj svgURL]];
		}
